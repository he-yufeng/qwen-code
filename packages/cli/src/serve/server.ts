...
export function createServeApp(
  ...
  // Helper: build a WorkspaceRequestContext from an incoming request.
  // Shared by workspace status/init/tool/MCP-restart routes so the
  // service receives a consistent context shape for audit + client-id
  // gating without each handler constructing it ad-hoc.
